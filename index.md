...
- **Probability Ratio**:  
  - $ratio_{i,t}$ is calculated as $exp(per\\_token\\_logps - old\\_per\\_token\\_logps)$ , stored in `coef_1`. This is the exponential of the log probability difference, equivalent to $\frac{\pi_#{\theta(o_{i,t})}}{\pi_{\theta_{old}}(o_{i,t})}$ .  
- **Clipped Term**:  
